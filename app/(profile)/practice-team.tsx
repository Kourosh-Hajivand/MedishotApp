...
export default function PracticeTeamScreen() {
  ...
  console.log("practiceMembers", practiceMembers?.data);
      ...
      <View className="pt-0 border-t border-system-gray5">
        {practiceMembers?.data.members.map((member, index) => (
          <TouchableOpacity
            ...
            className={`flex-row items-center justify-between pl-1 py-2 pr-4 disabled:opacity-60 ${index !== practiceMembers?.data.members.length - 1 ? "pb-2 border-b border-system-gray5" : ""}`}
            onPress={() => {
