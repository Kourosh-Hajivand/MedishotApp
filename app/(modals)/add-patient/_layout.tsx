...
export default function AddPatientModalLayout() {
    return (
        <Stack screenOptions={{ presentation: "modal" }} initialRouteName="select-doctor">
            <Stack.Screen name="select-doctor" options={{ headerTitle: "Select Doctor", headerLeft: () => <BackButton onPress={() => router.replace("/(tabs)/patients")} />, headerShadowVisible: true, headerTransparent: true, headerStyle: { backgroundColor: "transparent" }, gestureEnabled: false, fullScreenGestureEnabled: false }} />
            ...
            <Stack.Screen name="select-label" options={{ headerTitle: "Select Label", presentation: "modal", headerLeft: () => <BackButton onPress={() => router.back()} />, headerShadowVisible: true, headerTransparent: true, headerStyle: { backgroundColor: "transparent" } }} />
